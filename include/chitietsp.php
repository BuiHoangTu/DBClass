			...
			<div class="row">
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<div class="occasion-cart">
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out" style="margin-top: 24px;">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="hidden" name="soluongconlai" value="<?php echo $row_chitiet['sanpham_soluong'] ?>" />			
